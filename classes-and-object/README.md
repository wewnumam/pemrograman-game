...
- Simpan perubahan script dengan tekan `Ctrl+S`
    ...
    ```
3. Drag and Drop script *Latihan4.cs* ke GameObject `Main Camera` di `Hierarchy` Hilangkan centang pada `Latihan 3`. Jendela `Console` menampilkan log informasi dari Attribute function dan dari function `Jump()`.
